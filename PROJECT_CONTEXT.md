...
- 尚未完成此提交的 Windows EXE／發布驗證、乾淨新帳號、真正遊戲輸入及
  斷線重連驗收，因此 SP1 尚未正式完成。
...
先為 `2fae8bf` 建立並驗證 SP1 Windows 成品，再繼續乾淨 Windows 11 新
帳號驗收；現有 `C:\Users\USER\Desktop\輔` 專案 junction 與
