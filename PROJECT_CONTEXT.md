...
- 最新提交：`960bacb7260ea33f59c0724b219472fcbc36924e`
...
使用已驗證的 `960bacb` SP1 真實背景擷取版繼續乾淨 Windows 11 新帳號
...
唯讀實測已確認 14 個 Flash 程序各有唯一啟動參數指紋，且各自只對應一個
既有桌面啟動捷徑；原始參數與登入權杖均未輸出。是否採用不可逆匿名指紋
作為穩定視窗身分，仍待使用者確認。
