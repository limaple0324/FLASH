...
class LifeSoulEditorWindow:
    """管理單一命魂編輯視窗，操作失敗時保留原視窗與原紀錄。"""
    ...
    def __init__(
        ...
        *,
        ...
        self._renderer = renderer or render_life_soul_editor
    ...
    def open(self, display_name: str, initial_note: str | None = None) -> None:
        ...
        if self._window is not None:
            raise RuntimeError("Life soul editor window is already open.")
