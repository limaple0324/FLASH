...
目前最新功能來源是 `89cc78c`；729 項完整測試、原始碼編譯、來源／封裝
自我檢查、Windows 11 兩次圖形啟閉及成品解壓驗證均已通過。完整累積成品保存在
...
最新版本已包含正式五頁 UI、首頁今日已登記活動、提醒卡、角色清單／詳細
資料與備註、完整快捷鍵、鍵盤與滑鼠同步、連續點擊、角色狀態列、安全
重連、操作暫存／補做、紀錄查詢及角色登入優先選擇。2026-07-26 14:20
已依玩家更正登記為幻境，
2026-08-02 14:20 為奇石，之後隔週交替。
全專案角色預設優先序為
