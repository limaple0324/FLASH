...
APP_DISPLAY_NAME = "輔V0.2"
APP_VERSION = "V.02"
APP_VERSION_CODE = "v0.2"
APP_STABLE_BASELINE_NAME = "輔V0.2 架構整理基準"
APP_DATA_DIR_NAME = "輔V0.2"
APP_CONFIG_FILENAME = "sync_launch_config.json"
APP_OUTPUT_CONFIG_BACKUP_FILENAME = "sync_launch_config_v02.json"
...
DIB_RGB_COLORS = 0
SINGLE_INSTANCE_MUTEX_NAME = "Local\\FlashSyncAssistantV02SingleInstance"
SINGLE_INSTANCE_RESTORE_MESSAGE_NAME = "FlashSyncAssistantV02RestoreMessage"
...
def app_writable_path(name: str) -> str:
    ...
    legacy_names = [name]
    if name == APP_CONFIG_FILENAME:
        legacy_names = [APP_OUTPUT_CONFIG_BACKUP_FILENAME, name]
