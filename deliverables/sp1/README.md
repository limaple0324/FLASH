...
- 版本：SP1 0.1.3 完成候選版（0.1.2 舊工程成品保留）
...
2026-07-25 工作樹已加入 `B`／`C` 專用安全輸入、三種視窗操作權限、10 份
...
此工作尚未建立新的 commit、EXE 或 ZIP，不得覆蓋或冒充上方已驗證的
`0bd575c` 永久 SP1 成品。封裝成品及最終玩家驗收完成後，才可新增正式
成品紀錄；乾淨帳號／別台電腦驗證已由使用者決定延後，不得標成已通過。
